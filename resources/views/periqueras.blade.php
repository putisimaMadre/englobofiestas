...
<body class="portfolio-details-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid d-flex align-items-center justify-content-center position-relative">
      ...
      <img src="assets/img/enGlobo/periquerasTituloGrande2.jpeg" alt="EnGloboFiestas" class="logo-extremo-img">
    </a>
    ...
    <section id="portfolio-details" class="portfolio-details section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <!--==================.  3x3 ====================-->
          <!--<div class="text-center rounded p-3 w-100" style="background-image: url('assets/img/enGlobo/fondoInflables4.jpeg'); background-size: cover; background-position: center; width: 100%;">-->
            <div class="text-center">
              <img src="assets/img/enGlobo/periquerasBar.png" alt="Inflables 3x3" class="img-fluid" style="max-height: 200px; object-fit: contain;">
            </div>
        ...
        <!--==================.  3x3 ====================-->
          <!--<div class="text-center rounded p-3 w-100" style="background-image: url('assets/img/enGlobo/fondoInflables4.jpeg'); background-size: cover; background-position: center; width: 100%;">-->
            <div class="text-center">
              <img src="assets/img/enGlobo/periqueraVintage.png" alt="Inflables 3x3" class="img-fluid" style="max-height: 200px; object-fit: contain;">
            </div>
